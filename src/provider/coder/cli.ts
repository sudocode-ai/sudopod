/**
 * Coder CLI Wrapper — Remote Execution
 *
 * Exec function using `coder ssh` for remote command execution in Coder workspaces.
...
import type { ExecResult, ExecFn } from '../types.js';
