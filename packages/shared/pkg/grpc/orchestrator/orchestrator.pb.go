...
func (x *SandboxSnapshotRequest) GetExpiry() *timestamppb.Timestamp {
	if x != nil {
		return x.Expiry
	}
	return nil
...
type SandboxSnapshotResponse struct {
	...
	TemplateAlias string `protobuf:"bytes,1,opt,name=template_alias,json=templateAlias,proto3" json:"template_alias,omitempty"`
}
...
func (x *SandboxSnapshotResponse) GetTemplateAlias() string {
	if x != nil {
...
var file_orchestrator_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x6b, 0x0a, 0x16, 0x53, 0x61, 0x6e, 0x64, 0x62, 0x6f,
	...
	0x69, 0x72, 0x79, 0x22, 0x40, 0x0a, 0x17, 0x53, 0x61, 0x6e, 0x64, 0x62, 0x6f, 0x78, 0x53, 0x6e,
	0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x25,
	0x0a, 0x0e, 0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x5f, 0x61, 0x6c, 0x69, 0x61, 0x73,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65,
	0x41, 0x6c, 0x69, 0x61, 0x73, 0x22, 0x4b, 0x0a, 0x1f, 0x53, 0x61, 0x6e, 0x64, 0x62, 0x6f, 0x78,
	...
	0x64, 0x73, 0x32, 0xb5, 0x03, 0x0a, 0x0e, 0x53, 0x61, 0x6e, 0x64, 0x62, 0x6f, 0x78, 0x53, 0x65,
	...
	0x08, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x12, 0x17, 0x2e, 0x53, 0x61, 0x6e, 0x64,
	0x62, 0x6f, 0x78, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x18, 0x2e, 0x53, 0x61, 0x6e, 0x64, 0x62, 0x6f, 0x78, 0x53, 0x6e, 0x61, 0x70,
	0x73, 0x68, 0x6f, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x4c, 0x0a, 0x10,
	0x4c, 0x69, 0x73, 0x74, 0x43, 0x61, 0x63, 0x68, 0x65, 0x64, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x73,
...
var file_orchestrator_proto_goTypes = []interface{}{
	...
	(*SandboxSnapshotRequest)(nil),          // 9: SandboxSnapshotRequest
	(*SandboxSnapshotResponse)(nil),         // 10: SandboxSnapshotResponse
...
var file_orchestrator_proto_depIdxs = []int32{
	...
	14, // 11: SandboxSnapshotRequest.expiry:type_name -> google.protobuf.Timestamp
	...
	15, // 15: SandboxService.List:input_type -> google.protobuf.Empty
	4,  // 16: SandboxService.Delete:input_type -> SandboxDeleteRequest
	5,  // 17: SandboxService.Pause:input_type -> SandboxPauseRequest
	9,  // 18: SandboxService.Snapshot:input_type -> SandboxSnapshotRequest
	...
	10, // 25: SandboxService.Snapshot:output_type -> SandboxSnapshotResponse
	11, // 26: SandboxService.ListCachedBuilds:output_type -> SandboxListCachedBuildsResponse
...
func file_orchestrator_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_orchestrator_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SandboxSnapshotRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_orchestrator_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SandboxSnapshotResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
