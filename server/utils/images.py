...
pip install pytest mock coverage loguru ipdb pylint gunicorn uvicorn docker black flake8 pipenv python-dotenv flask django fastapi sqlalchemy psycopg2 mongoengine celery pipreqs
